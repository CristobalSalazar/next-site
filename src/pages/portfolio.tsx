    ...
    >
      <Layout activeLinkName="Portfolio">
        <div className="layout">
          <main className="main-portfolio" role="main">
            <section className="portfolio" id="web">
            ...
            <section className="portfolio" id="unity">
              <h1 className="heading">Unity</h1>
              <div className="project-reel">
                <Project
            ...
            <section className="portfolio" id="console">
              <h1 className="heading">Console</h1>
              <div className="project-reel">
                <Project
                  title="Pathfinder"
                  description="
